...
const EVIC_MINI_ROM_SIZE: usize = 120 * 1024;
...
impl Firmware {
    /// Initialize a new firmware structure with the capacity equal to the ROM capacity.
    fn new() -> Firmware {
        Firmware {
    ...
    /// Decrypt the firmware behind the provided reader.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Write the contents of the firmware buffer to the provided writer.
...
/// Load firmware specified by file path and decrypt it into memory.
